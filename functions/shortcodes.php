	...
	<div class="container">
		<div class="row">
			<?php
				...
				$wp_query->query('post_type=post&category_name=heja&posts_per_page=3&orderby=date&order=DESC');
				$count = 0;
			?>
			<?php
			...
			?>
  			<div class="col-md-4">
				...
				<div class="borda-meio">
					<p class="category-news center"><span>HEJA em A&ccedil;&atilde;o</span></p>
				</div>
